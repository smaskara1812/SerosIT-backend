...
VALUES
    ('masters.crew_change_reliever_mapping', 'Crew Change Reliever Mapping', 'Masters · HR Mapping Masters', 45, 4,
     1,1,1,1, 0,0, 1, NOW(), NOW());

SELECT menu_key, menu_label, menu_group FROM serosIT.sys_menu WHERE menu_key = 'masters.crew_change_reliever_mapping';

...
VALUES
    ('masters.notification_triggers', 'Notification Triggers', 'Masters · Mail Alert Masters', 33, 4,
     1, 1, 1, 1, 1, 0, 1, NOW(), NOW());

SELECT menu_key, menu_label, menu_group, menu_order FROM serosIT.sys_menu WHERE menu_key = 'masters.notification_triggers';

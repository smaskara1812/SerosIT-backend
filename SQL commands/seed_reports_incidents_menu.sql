...
VALUES
    ('reports.incidents', 'Incidents', 'Reports', 70, 1, 1,0,0,0, 1,0, 1, NOW(), NOW());

SELECT menu_key, menu_label, menu_group, HEX(menu_group) FROM serosIT.sys_menu WHERE menu_key = 'reports.incidents';

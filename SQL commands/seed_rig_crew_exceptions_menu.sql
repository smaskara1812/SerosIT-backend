...
VALUES
    ('masters.rig_crew_exceptions', 'Rig Crew Exceptions', 'Masters · Exception Masters', 48, 1,
     1,1,1,1, 0,0, 1, NOW(), NOW());

SELECT menu_key, menu_label, menu_group, HEX(menu_group) FROM serosIT.sys_menu WHERE menu_key = 'masters.rig_crew_exceptions';

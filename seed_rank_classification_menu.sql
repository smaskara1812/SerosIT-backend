...
VALUES
    ('masters.rank_classification', 'Rank Classification', 'Masters · HR Mapping Masters', 45, 2,
     1,1,1,1, 0,0, 1, NOW(), NOW());

SELECT menu_key, menu_label, menu_group FROM serosIT.sys_menu WHERE menu_key = 'masters.rank_classification';
